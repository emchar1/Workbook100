...
//        contentView.layer.cornerRadius = CollectionCellOLD.cornerRadius
        ...
        //hStackBottom
        ruleLine = RuleLine(frame: CGRect(x: 0, y: 0, width: CollectionCell.collectionCellWidth, height: 20),
                            from: CGPoint(x: 0, y: CollectionCell.collectionCellHeight / 2),
                            to: CGPoint(x: frame.width, y: CollectionCell.collectionCellHeight / 2))
