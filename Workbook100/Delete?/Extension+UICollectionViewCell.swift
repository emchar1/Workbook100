...
extension UICollectionViewCell {
    ...
    /* This is defunct, I believe... Waiting a bit before deleting it.
    ...
    /* Defunct??? And should go in CollectionCell.swift?
    /**
...
//        self.transform = CGAffineTransform(scaleX: 1 - scale, y: 1 - scale)
        ...
        let scale = factor / CollectionCell.collectionCellWidth // factor
