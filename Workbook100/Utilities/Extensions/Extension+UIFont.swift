...
extension UIFont {
    static let workbookTitle = UIFont(name: "AvenirNext-Bold", size: 24)!
    static let workbookBubbleTitle = UIFont(name: "AvenirNext-Bold", size: 22)!
    static let workbookSubtitle = UIFont(name: "TimesNewRomanPS-ItalicMT", size: 19)!
